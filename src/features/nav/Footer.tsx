...
export function Footer() {
  return (
    <footer className="bg-[linear-gradient(to_bottom,#080810_0%,#04100d_100%)] w-full py-8 px-6 flex flex-col items-center gap-4 text-white/30 text-xs border-t border-[rgba(255,255,255,0.06)]">
      {/* 연락처 */}
